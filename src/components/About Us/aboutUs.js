            ...
            <div className = "aboutContainer">
                ...
                <div className = "rowContainer">
                    ...
                    <div className = "colEightContainer">
                           ...
                           data-aos="fade-right"
                           data-aos-offset="300"
                           data-aos-easing="ease-in-sine">Hello! Aman this side, I have completed my Bachelor of Technology from Guru Tegh Bahadur Institute of Technology with good aggregate up to 87.95%. I'm <strong>Frontend</strong> and <strong>Data Structure</strong> Enthusiast. I have <strong>1 year and 3 months of
